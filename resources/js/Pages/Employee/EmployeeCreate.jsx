...
export default function EmployeeCreate() {
    ...
    const handleCepChange = async (cep) => {
        const formattedCep = cep.replace(/[^\d]/g, ''); // Remove qualquer caractere não numérico
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value={data.cpf}
                            onChange={(e) => {
                                const cleanedCpf = e.target.value.replace(/[^\d]/g, ''); // Remove qualquer caractere não numérico
                                setData("cpf", cleanedCpf); 
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setData("logradouro", e.target.value)
                            }
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setData("localidade", e.target.value)
                            }
                            placeholder="Cidade"
                            className="mt-2 p-3 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
